...
def copy_to_clipboard(text: str) -> tuple[bool, str]:
    try:
        ...
        return True, "Copied result to clipboard."
    except Exception:
        pass
    ...
    try:
        ...
        return False, f"Could not copy result to clipboard: {error}"
...
def main() -> None:
    ...
    if args.message:
        ...
        copied, clipboard_message = copy_to_clipboard(rewritten)
        print(f"{clipboard_message}\n")
